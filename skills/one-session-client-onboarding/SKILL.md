...
- `gct-screen` — independent-review candidate, then Ops roster, before this session is SAE onboarding
- `social-amplification-engine` — the six-phase package after Active Client; stage-only until exact authority
