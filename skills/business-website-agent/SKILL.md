...
1. **Hero** — company name, the customer's recognizable need, your supported value and a clear next step (call or request a quote), with an authority image of your crew on a real job. In the first 2–3 sentences, make clear who you help, why the work matters and how this service helps; use the specific-GCT opening standard. Show genuine relevant work, not stock.
...
## Copy rules
- Lead with facts that help the customer choose. Explain relevant value in plain language; do not make an entity homepage a dry company inventory. Every material claim needs its source, and service/landing pages connect relevant proof to the next buying step.
...
## Steps
1. Draft the homepage and one page per core service from the brief and scored proof only. Each opening serves that page's specific reader and decision; retain its exact text and source-backed relevance/value review in the existing page inventory. A repeated generic entrepreneur pitch fails.
