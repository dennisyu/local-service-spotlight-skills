...
3. **Definitive article** — write the ONE canonical long-form hub (`definitive-article-writer`). Its first 2–3 sentences connect a true source moment or finding to the reader's situation, why it matters and the useful action or lesson. Apply the shared specific-GCT opening review to the hub and adapt it to each derivative's actual reader and format. The hub is the product; everything else is distribution.
...
- Reference: https://blitzmetrics.com/content-factory/ · https://dennisyu.com/topic-wheel/
- Pairs with: dollar-a-day-strategist → **content-factory** → definitive-article-writer → recursive-self-improvement-qa
