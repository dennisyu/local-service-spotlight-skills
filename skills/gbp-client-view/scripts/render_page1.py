# -*- coding: utf-8 -*-
"""Render the Local Service Spotlight client-view page-1 one-pager (GA4 and GBP share this) from a derived page1-spec JSON.
...
def citations_foot(d):
    ...
    if cit.get("gbp_url"): left_bits.append(f'<a href="{esc(cit["gbp_url"])}">Google Business Profile</a>')
