# Client-View Display Standard (shared by GA4 and GBP pages)
...
1. **Pills: exactly four, always** — GA4: Leads · Calls · Forms · Lead rate (or the model's
   named equivalents). GBP: primary action · secondary · third · Maps views. Never swap a pill for something else.
...
3. **Chart titles are fixed** — GA4: left "Weekly leads · {13 weeks | recent weeks}", right
   "Leads by channel". GBP: left "Weekly {primary action} · last 13 weeks", right "Actions by type · last 13 weeks". When data forces a short trend or a tracked-vs-untracked split,
