---
{
  "title": "Every task execution writes a meta article",
  "severity": "error",
  "captured": "2026-09-05",
  "captured_from": "Dennis Yu, Codex task follow-up, 2026-09-05: task-definitive articles are canonical recipes; every task execution writes a meta article linked to the task and run evidence; history improves the recipe and counts distinct executions. Publication follows existing authorization.",
  "source": "https://localservicespotlight.com/meta-articles/",
  "applies_to": [
    "agent-behaviour"
  ]
}
