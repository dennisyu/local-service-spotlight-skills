---
{
  "title": "A photograph has to earn full bleed",
  "severity": "warn",
  "captured": "2026-08-16",
  "captured_from": "Agent failure on 2026-08-15 while building the georgepaladichuk.com hero: an agent selected hero candidates by resolution and file size without opening them, and presented selfies as a full-bleed option. The corrected decision rule — genre first, resolution second — is this standard.",
