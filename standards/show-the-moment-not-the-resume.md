---
{
  "title": "Show the moment, not the resume",
  "severity": "warn",
  "captured": "2026-09-05",
  "captured_from": "Dennis Yu, Codex requests, 2026-09-05 and 2026-09-06: use real pictures, videos, moments, experiences, and relationships without sounding defensive, doubtful, boastful, embellished, or name-dropping; show the breadth of the Money Tree and its purpose, relationships, published work and useful next steps across the fleet.",
  "applies_to": [
    "design-review"
  ]
}
